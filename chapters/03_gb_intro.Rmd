...
```{r keysight-setup, echo = FALSE, out.width = "70%", fig.cap = "Messaufbau am Keysight B1500A."}
...
```{r keythley-setup, echo = FALSE, out.width = "70%", fig.cap = "Messaufbau am Keithley 2450. (Bild austauschen. Falsch verkabelt...)"}
