...
Einen geeigneten Haken zu finden, der fein genug ist, um ohne Schwierigkeiten 
unter den Loop eines Bonds passt, stellte sich als schwierig heraus. Die beste 
Lösung die wir gefunden haben, ist die Verwendung einer feinen Messspitze. 
Diese habe ich vorsichtig zurechtgebogen, um einen Haken zu formen (siehe 
Abbildung \@ref(fig:pulltester-tip)).
