...
```{r}
data_screening <- read_rds(
  here::here("data/gatebreak/gb-screening.rds")
)
...
```{r recommended-values, echo = FALSE, fig.cap = "Empfohlene Werte aus dem Handbuch des tpt HB-10 Bonders für Golddraht.", out.width="60%"}
knitr::include_graphics(
  here::here("static/img/tpt_recommended.png")
)
```
...
```{r screening-litho, echo = FALSE, fig.cap="Verwendete Probengeometrie zum Messen von Gate-Durchbrüchen.", out.width="75%"}
knitr::include_graphics(
  here::here("static/img/gatebreak/gb-litho-check.png")
)
```
...
```{r screening-plot-effect, echo = FALSE, fig.height = 4.5, fig.cap = "Effektplot der untersuchten Faktoren. Die Steigung ist ein Maß für die Stärke eines Effekts."}
...
```{r gb-screening-contour, fig.height = 2.5, fig.cap="Contour-Plot der Regressionsfunktion.", cache=TRUE}
