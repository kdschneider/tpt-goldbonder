...
Um den kompletten Bericht lokal zu rendern, kann das R-Script `_build.R` ausgeführt werden. Die benötigten Pakete können über das R-Paket `{renv}` mit dem Befehl `renv::hydrate()` installiert werden. Dieser installiert alle in der Datei `renv.lock` aufgeführten Pakete in der korrekten Version. 
